	...
	return (
		<>
			...
			<FormItem noStyle dependencies={[[index, 'type']]}>
				{({ getFieldValue }) => (
					<>
						{haveCollection(getFieldValue(NAME_FIELD)[index].type) && (
							<FormItem
								label="Collection"
						...
						{showBucket(getFieldValue(NAME_FIELD)[index].type) && (
							<>
								<FormItem
									label="Bucket"
									name={[index, 'bucket']}
						...
						{haveTopic(getFieldValue(NAME_FIELD)[index].type) && (
							<FormItem
								label="Topic"
								name={[index, 'topic']}
						...
						{haveTableList(getFieldValue(NAME_FIELD)[index].type) &&
						...
						{haveDataPreview(getFieldValue(NAME_FIELD)[index].type) && (
							<FormItem
								wrapperCol={{
			...
			>
				{({ getFieldValue }) =>
					haveTableColumn(getFieldValue(NAME_FIELD)[index].type) ? (
			...
			<FormItem noStyle dependencies={[[index, 'type']]}>
				{({ getFieldValue }) => (
					<>
						...
						{haveUpdateMode(getFieldValue(NAME_FIELD)[index].type) && (
							<>
								<FormItem
									label="更新模式"
			...
			<FormItem hidden={!showAdvancedParams} noStyle dependencies={[[index, 'type']]}>
				{({ getFieldValue }) => (
					<>
						{haveParallelism(getFieldValue(NAME_FIELD)[index].type) && (
